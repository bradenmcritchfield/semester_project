...
st.markdown("**Min Players:** the minimum number of players the game requires. **Max Players:** the maximum number of players the game allows. **Playing Time:** estimated amount of time a game takes.  **Age Minimum:** recommended minimum age of players.  **Number of Accessories:** number of accessories in the game.  **Number of Ratings:** number of people who have given a rating for the game. **Year Published:** the year the game was first published. **Average Rating:** average of all ratings. **Bayes Rating:** average of all ratings plus 30 average ratings. **Standard Deviation:** the standard deviation of the ratings. **Average USD Price:** average price of games being sold in BGG's marketplace at time of data pull. **Age (Years):** age of the game in years. **Time Category:** category of game based on legnth of gameplay. **AgeRating:** category based on age minimum. **GroupSize:** category based on maximum number of players.")